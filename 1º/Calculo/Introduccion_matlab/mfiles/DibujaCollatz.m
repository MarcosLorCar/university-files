...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%DIBUJACOLLATZ Dibuja la sucesión de Collatz
%            generada a partir de n
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
suc=collatz(n); % Genera la sucesión de Collatz
plot(suc,'*-')  % Dibuja la sucesión contenida en suc
title(['Sucesión de Collatz comenzando en ' int2str(suc(1))],'FontSize',16)
